...
abstract contract CodeConstants {
    // VRF Mock values
    uint96 public MOCK_BASE_REE = 0.25 ether;
...
contract HelperConfig is CodeConstants, Script {
    ...
    function getSepoliaEthConfig() public pure returns (NetworkConfig memory) {
        return NetworkConfig({
            ...
            subscriptionId: 33487284432980235960603841651871927239401337820523329717582031887859479289402,
    ...
    function getOrCreateAnvilEthConfig() public returns (NetworkConfig memory) {
        ...
        VRFCoordinatorV2_5Mock vrfCoordinatorMock =
            new VRFCoordinatorV2_5Mock(MOCK_BASE_REE, MOCK_GAS_PRICE_LINK, MOCK_WEI_PER_UINT_LINK);
